...
class ImageDropAnalyzer {
        ...
        this.container.innerHTML = `
            <div class="image-drop-zone" id="imageDropZone">
                <div class="drop-zone-content">
                    ...
                    <p>Drag and drop an image, or paste from clipboard (Ctrl+V / Cmd+V)</p>
    ...
    setupPasteHandler() {
        ...
        const handlePaste = async (e) => {
            // Only handle paste if the drop zone is visible (not analyzing)
            if (this.isAnalyzing || this.analysisProgress.style.display === 'block') {
                return;
            }
            
            // Check if the paste event is within our container or modal
            const isWithinContainer = this.container.contains(e.target) || 
                                     e.target.closest('.modal') ||
                                     e.target.closest('#imageAnalyzerModal');
        ...
        // Add paste listener to document (works when modal is focused)
        document.addEventListener('paste', handlePaste);
        
        // Also add to container for better focus handling
        this.container.addEventListener('paste', handlePaste);
